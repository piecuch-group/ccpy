...
latex_documents = [
    (master_doc, 'ccpy.tex', 'CCpy Documentation',
     'ccpy', 'manual'),
]
...
man_pages = [
    (master_doc, 'ccpy', 'CCpy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ccpy', 'CCpy Documentation',
     author, 'CCpy', 'A Coupled-Cluster Package Written in Python.',
     'Miscellaneous'),
]

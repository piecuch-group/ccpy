module ccp3_adaptive_loops
    ...
    implicit none
            ...
            contains
!                    subroutine ccp3a_2ba_with_selection(deltaA,deltaB,deltaC,deltaD,&
!                              moments,&
!                              triples_list,&
!                              t3a_excits,&
!                              t2a,l1a,l2a,&
...
!                              D3A_O,D3A_v,&
!                              n3aaa,noa,nua,num_add)
!
!                        real(kind=8), intent(out) :: deltaA, deltaB, deltaC, deltaD
!                        integer, intent(in) :: noa, nua, n3aaa, num_add
...
!
!              end subroutine ccp3a_2ba_with_selection
!
!              subroutine ccp3b_2ba_with_selection(deltaA,deltaB,deltaC,deltaD,&
!                              moments,&
!                              triples_list,&
!                              t3b_excits,&
...
!                              n3aab,noa,nua,nob,nub,num_add)
!
!                        real(kind=8), intent(out) :: deltaA, deltaB, deltaC, deltaD
!                        integer, intent(in) :: noa, nua, nob, nub, n3aab, num_add
...
!                        deallocate(loc_arr,idx_table)
!
!              end subroutine ccp3b_2ba_with_selection
!
!              subroutine ccp3c_2ba_with_selection(deltaA,deltaB,deltaC,deltaD,&
!                              moments,&
!                              triples_list,&
!                              t3c_excits,&
...
!                              n3abb,noa,nua,nob,nub,num_add)
!
!                        real(kind=8), intent(out) :: deltaA, deltaB, deltaC, deltaD
!                        integer, intent(in) :: noa, nua, nob, nub, n3abb, num_add
...
!                        deallocate(loc_arr,idx_table)
!
!              end subroutine ccp3c_2ba_with_selection
!
!              subroutine ccp3d_2ba_with_selection(deltaA,deltaB,deltaC,deltaD,&
!                              moments,&
!                              triples_list,&
!                              t3d_excits,&
!                              t2c,l1b,l2c,&
...
!                              H2C_voov,H2C_oooo,H2C_vvvv,&
!                              D3D_O,D3D_V,&
!                              n3bbb,nob,nub,num_add)
!
!                        real(kind=8), intent(out) :: deltaA, deltaB, deltaC, deltaD
!                        integer, intent(in) :: nob, nub, n3bbb, num_add
...
!                        deallocate(loc_arr,idx_table)
!
!              end subroutine ccp3d_2ba_with_selection
              ...
              subroutine ccp3a_full_with_selection_opt(deltaA,deltaB,deltaC,deltaD,&
                              moments,&
                              triples_list,&
                              nfill,&
                              M3A,L3A,&
                        ...
                        integer, intent(in) :: noa, nua, n3aaa, buf_fact, num_add
                        integer, intent(in) :: t3a_excits(6,n3aaa)
                        real(kind=8), intent(in) :: M3A(nua,nua,nua,noa,noa,noa),&
                                                    L3A(nua,nua,nua,noa,noa,noa),&
                                                    fA_oo(1:noa,1:noa),fA_vv(1:nua,1:nua),&
                                                    H1A_oo(1:noa,1:noa),H1A_vv(1:nua,1:nua),&
                                                    H2A_voov(1:nua,1:noa,1:noa,1:nua),&
                                                    H2A_oooo(1:noa,1:noa,1:noa,1:noa),&
                        ...
                        integer :: i, j, k, a, b, c, isort(buf_fact*num_add)
              ...
              end subroutine ccp3a_full_with_selection_opt

              subroutine eomccp3a_full_with_selection_opt(deltaA,deltaB,deltaC,deltaD,&
                              moments,&
                              triples_list,&
                              nfill,&
                              EOM3A,M3A,L3A,&
                        ...
                        real(kind=8), intent(out) :: deltaA, deltaB, deltaC, deltaD
                        integer, intent(in) :: noa, nua, n3aaa, buf_fact, num_add
                        integer, intent(in) :: r3a_excits(6,n3aaa)
                        real(kind=8), intent(in) :: EOM3A(nua,nua,nua,noa,noa,noa),&
                                                    M3A(nua,nua,nua,noa,noa,noa),&
                                                    L3A(nua,nua,nua,noa,noa,noa),&
                                                    fA_oo(1:noa,1:noa),fA_vv(1:nua,1:nua),&
                                                    H1A_oo(1:noa,1:noa),H1A_vv(1:nua,1:nua),&
                                                    H2A_voov(1:nua,1:noa,1:noa,1:nua),&
              ...
              end subroutine eomccp3a_full_with_selection_opt
              ...
              subroutine ccp3b_full_with_selection_opt(deltaA,deltaB,deltaC,deltaD,&
                              moments,&
                              triples_list,&
                              nfill,&
                              M3B,L3B,&
                        ...
                        integer, intent(in) :: noa, nua, nob, nub, n3aab, num_add, buf_fact
                        integer, intent(in) :: t3b_excits(6,n3aab)
                        real(kind=8), intent(in) :: M3B(nua,nua,nub,noa,noa,nob),&
                                                    L3B(nua,nua,nub,noa,noa,nob),&
                                                    fA_oo(1:noa,1:noa),fA_vv(1:nua,1:nua),&
                                                    fB_oo(1:nob,1:nob),fB_vv(1:nub,1:nub),&
                                                    H1A_oo(1:noa,1:noa),H1A_vv(1:nua,1:nua),&
                                                    H1B_oo(1:nob,1:nob),H1B_vv(1:nub,1:nub),&
              ...
              end subroutine ccp3b_full_with_selection_opt
              
              subroutine eomccp3b_full_with_selection_opt(deltaA,deltaB,deltaC,deltaD,&
                              moments,&
                              triples_list,&
                              nfill,&
                              EOM3B,M3B,L3B,&
                        ...
                        real(kind=8), intent(out) :: deltaA, deltaB, deltaC, deltaD
                        integer, intent(in) :: noa, nua, nob, nub, n3aab, num_add, buf_fact
                        integer, intent(in) :: r3b_excits(6,n3aab)
                        real(kind=8), intent(in) :: EOM3B(nua,nua,nub,noa,noa,nob),&
                                                    M3B(nua,nua,nub,noa,noa,nob),&
                                                    L3B(nua,nua,nub,noa,noa,nob),&
                                                    fA_oo(1:noa,1:noa),fA_vv(1:nua,1:nua),&
                                                    fB_oo(1:nob,1:nob),fB_vv(1:nub,1:nub),&
                                                    H1A_oo(1:noa,1:noa),H1A_vv(1:nua,1:nua),&
              ...
              end subroutine eomccp3b_full_with_selection_opt
              ...
              subroutine ccp3c_full_with_selection_opt(deltaA,deltaB,deltaC,deltaD,&
                              moments,&
                              triples_list,&
                              nfill,&
                              M3C,L3C,&
                        ...
                        integer, intent(in) :: noa, nua, nob, nub, n3abb, num_add, buf_fact
                        integer, intent(in) :: t3c_excits(6,n3abb)
                        real(kind=8), intent(in) :: M3C(nua,nub,nub,noa,nob,nob),&
                                                    L3C(nua,nub,nub,noa,nob,nob),&
                                                    fA_oo(1:noa,1:noa),fA_vv(1:nua,1:nua),&
                                                    fB_oo(1:nob,1:nob),fB_vv(1:nub,1:nub),&
                                                    H1A_oo(1:noa,1:noa),H1A_vv(1:nua,1:nua),&
                                                    H1B_oo(1:nob,1:nob),H1B_vv(1:nub,1:nub),&
                                    ...
                                    do a = 1, nua
                                        do b = 1, nub
                                            do c = b+1, nub
                                                ...
                                                LM = M3C(a,b,c,i,j,k)*L3C(a,b,c,i,j,k)
              ...
              end subroutine ccp3c_full_with_selection_opt
              
              subroutine eomccp3c_full_with_selection_opt(deltaA,deltaB,deltaC,deltaD,&
                              moments,&
                              triples_list,&
                              nfill,&
                              EOM3C,M3C,L3C,&
                        ...
                        real(kind=8), intent(out) :: deltaA, deltaB, deltaC, deltaD
                        integer, intent(in) :: noa, nua, nob, nub, n3abb, num_add, buf_fact
                        integer, intent(in) :: r3c_excits(6,n3abb)
                        real(kind=8), intent(in) :: EOM3C(nua,nub,nub,noa,nob,nob),&
                                                    M3C(nua,nub,nub,noa,nob,nob),&
                                                    L3C(nua,nub,nub,noa,nob,nob),&
                                                    fA_oo(1:noa,1:noa),fA_vv(1:nua,1:nua),&
                                                    fB_oo(1:nob,1:nob),fB_vv(1:nub,1:nub),&
                                                    H1A_oo(1:noa,1:noa),H1A_vv(1:nua,1:nua),&
                                    ...
                                    do a = 1, nua
                                        do b = 1, nub
                                            do c = b+1, nub
                                                ...
                                                LM = (r0*M3C(a,b,c,i,j,k) + EOM3C(a,b,c,i,j,k))*L3C(a,b,c,i,j,k)
              ...
              end subroutine eomccp3c_full_with_selection_opt
              ...
              subroutine ccp3d_full_with_selection_opt(deltaA,deltaB,deltaC,deltaD,&
                              moments,&
                              triples_list,&
                              nfill,&
                              M3D,L3D,&
                        ...
                        integer, intent(in) :: nob, nub, n3bbb, num_add, buf_fact
                        integer, intent(in) :: t3d_excits(6,n3bbb)
                        real(kind=8), intent(in) :: M3D(nub,nub,nub,nob,nob,nob),&
                                                    L3D(nub,nub,nub,nob,nob,nob),&
                                                    fB_oo(1:nob,1:nob),fB_vv(1:nub,1:nub),&
                                                    H1B_oo(1:nob,1:nob),H1B_vv(1:nub,1:nub),&
                                                    H2C_voov(1:nub,1:nob,1:nob,1:nub),&
                                                    H2C_oooo(1:nob,1:nob,1:nob,1:nob),&
                                    ...
                                    do a = 1, nub
                                        do b = a+1, nub
                                            do c = b+1, nub
                                                ...
                                                LM = M3D(a,b,c,i,j,k)*L3D(a,b,c,i,j,k)
              ...
              end subroutine ccp3d_full_with_selection_opt
              
              subroutine eomccp3d_full_with_selection_opt(deltaA,deltaB,deltaC,deltaD,&
                              moments,&
                              triples_list,&
                              nfill,&
                              EOM3D,M3D,L3D,&
                        ...
                        real(kind=8), intent(out) :: deltaA, deltaB, deltaC, deltaD
                        integer, intent(in) :: nob, nub, n3bbb, num_add, buf_fact
                        integer, intent(in) :: r3d_excits(6,n3bbb)
                        real(kind=8), intent(in) :: EOM3D(nub,nub,nub,nob,nob,nob),&
                                                    M3D(nub,nub,nub,nob,nob,nob),&
                                                    L3D(nub,nub,nub,nob,nob,nob),&
                                                    fB_oo(1:nob,1:nob),fB_vv(1:nub,1:nub),&
                                                    H1B_oo(1:nob,1:nob),H1B_vv(1:nub,1:nub),&
                                                    H2C_voov(1:nub,1:nob,1:nob,1:nub),&
                                    ...
                                    do a = 1, nub
                                        do b = a+1, nub
                                            do c = b+1, nub
                                                ...
                                                LM = (r0*M3D(a,b,c,i,j,k) + EOM3D(a,b,c,i,j,k))*L3D(a,b,c,i,j,k)
              ...
              end subroutine eomccp3d_full_with_selection_opt

              ...
              subroutine update_t3b_p(resid,&
                  ...
                  do idet = 1, n3aab
                      ...
                      do jdet = id3b_abk(iabk,1), id3b_abk(iabk,2)
                         ...
                         ! case 1: i==l, j==m
                         !if (i==l .and. j==m) hmatel = hmatel - h2b_ovov(l,c,i,f) - h2b_ovov(m,c,j,f)
                         ! case 2: i==l, j/=m
                         !if (i==l .and. j/=m) hmatel = hmatel - h2b_ovov(m,c,j,f)
                         ! case 3: i/=l, j==m
                         !if (i/=l .and. j==m) hmatel = hmatel - h2b_ovov(l,c,i,f)
                         ! case 4: i==m, j/=l
                         !if (i==m .and. j/=l) hmatel = hmatel + h2b_ovov(l,c,j,f)
                         ! case 5: i/=m, j==l
                         !if (i/=m .and. j==l) hmatel = hmatel + h2b_ovov(m,c,i,f)
                         resid(idet) = resid(idet) + hmatel * t3b_amps(jdet)
                      end do
                  end do ! end loop over idet
                  !$omp end do

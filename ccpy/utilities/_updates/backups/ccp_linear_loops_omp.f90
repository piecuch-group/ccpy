...
!!!!      USE MKL_SERVICE
      ...
      contains
              ...
              subroutine update_t3a_p(t3a_amps, resid,&
                  ...
                  !$omp parallel do reduction(+ : x3a,I2A_vooo,I2A_vvov)
                  do idet = 1, n3aaa
                      t_amp = t3a_amps(idet)
                  ...
                  ! Update loop
                  !$omp parallel do reduction(+ : t3a_amps)
                  do idet = 1, n3aaa
                      a = t3a_excits(idet, 1); b = t3a_excits(idet, 2); c = t3a_excits(idet, 3);
                      i = t3a_excits(idet, 4); j = t3a_excits(idet, 5); k = t3a_excits(idet, 6);
              ...
              subroutine update_t3b_p(t3b_amps, resid,&
                  ...
                  !$omp parallel do reduction(+ : x3b,I2A_vooo,I2A_vvov)
                  do idet = 1, n3aaa
                      t_amp = t3a_amps(idet)
                  ...
                  !$omp parallel do reduction(+ : x3b,I2A_vooo,I2A_vvov,I2B_vooo,I2B_ovoo,I2B_vvov,I2B_vvvo)
                  do idet = 1, n3aab
                      t_amp = t3b_amps(idet)
                  ...
                  !$omp parallel do reduction(+ : x3b,I2B_vooo,I2B_ovoo,I2B_vvov,I2B_vvvo)
                  do idet = 1, n3abb
                      t_amp = t3c_amps(idet)
                  ...
                  ! Update loop
                  !$omp parallel do reduction(+ : t3b_amps)
                  do idet = 1, n3aab
                      a = t3b_excits(idet, 1); b = t3b_excits(idet, 2); c = t3b_excits(idet, 3);
                      i = t3b_excits(idet, 4); j = t3b_excits(idet, 5); k = t3b_excits(idet, 6);
...
end module ccp_linear_loops_omp

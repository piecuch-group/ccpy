module cc_loops
  ...
  contains
      ...
      subroutine update_t3a_v2(t3a,X3A,fA_oo,fA_vv,shift,noa,nua)
      ...
      subroutine update_t3b_v2(t3b,X3B,fA_oo,fA_vv,fB_oo,fB_vv,shift,noa,nua,nob,nub)
                          ...
                          do aa = 1,nua
                              do bb = aa+1,nua
                                  do cc = 1,nub
                                      ...
                                      t3b(a,b,c,i,j,k) = t3b(a,b,c,i,j,k) + val/(denom-shift)
                                      t3b(b,a,c,i,j,k) = -t3b(a,b,c,i,j,k)
                                      t3b(a,b,c,j,i,k) = -t3b(a,b,c,i,j,k)
                                      t3b(b,a,c,j,i,k) = t3b(a,b,c,i,j,k)
      ...
      subroutine update_t3c_v2(t3c,X3C,fA_oo,fA_vv,fB_oo,fB_vv,shift,noa,nua,nob,nub)
                          ...
                          do aa = 1,nua
                              do bb = 1,nub
                                  do cc = bb+1,nub
                                      ...
                                      t3c(a,b,c,i,j,k) = t3c(a,b,c,i,j,k) + val/(denom-shift)
                                      t3c(a,c,b,i,j,k) = -t3c(a,b,c,i,j,k)
                                      t3c(a,b,c,i,k,j) = -t3c(a,b,c,i,j,k)
                                      t3c(a,c,b,i,k,j) = t3c(a,b,c,i,j,k)
      ...
      subroutine update_t3d_v2(t3d,X3D,fB_oo,fB_vv,shift,nob,nub)

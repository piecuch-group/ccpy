              ...
              subroutine build_moments3c_ijk(resid, i, j, k,&
                  ...
                  do a=1,nua; do b=1,nub; do c=b+1,nub;
                     ...
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        ...
                        resid(a,b,c) = resid(a,b,c) + (hmatel + hmatel1 + hmatel2 + hmatel3 + hmatel4)*t3c_amps_copy(jdet)
                     end do
                  end do; end do; end do;
                  !$omp end do
                  !$omp end parallel
                  ...
                  do a=1,nua; do b=1,nub; do c=b+1,nub;
                     ...
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        ...
                        hmatel1 = 0.0d0
                        if (m==j) hmatel1 = -h1a_oo(l,i)
                        resid(a,b,c) = resid(a,b,c) + (hmatel + hmatel1)*t3c_amps_copy(jdet)
                     end do
                     ! (jk)
                  ...
                  do a=1,nua; do b=1,nub; do c=b+1,nub;
                     ...
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        ...
                        hmatel = h2b_oooo(l,n,i,k)
                        resid(a,b,c) = resid(a,b,c) + hmatel * t3c_amps_copy(jdet)
                     end do
                     ! (jk)
                     idx = idx_table(b,c,a,k)
                     if (idx/=0) then
                  ...
                  do a=1,nua; do b=1,nub; do c=b+1,nub;
                     ...
                     do e = 1, nua
                        ...
                        resid(a,b,c) = resid(a,b,c) + H2B_vvvo(e,a,b,j) * t2b(e,c,i,k)
                        resid(a,b,c) = resid(a,b,c) - H2B_vvvo(e,a,b,k) * t2b(e,c,i,j)
                        resid(a,b,c) = resid(a,b,c) - H2B_vvvo(e,a,c,j) * t2b(e,b,i,k)
                        resid(a,b,c) = resid(a,b,c) + H2B_vvvo(e,a,c,k) * t2b(e,b,i,j)
                     end do
                  end do; end do; end do;
                  !$omp end do
                  !$omp end parallel
                  ...
                  do a=1,nua; do b=1,nub; do c=b+1,nub;
                     if (.not. qspace(a,b,c)) cycle
                      do e = 1, nub
                         ...
                         resid(a,b,c) = resid(a,b,c) + H2B_vvov(e,a,b,i) * t2c(e,c,j,k)
                         resid(a,b,c) = resid(a,b,c) - H2B_vvov(e,a,c,i) * t2c(e,b,j,k)
                      end do
                   end do; end do; end do;
                   !$omp end do
                   !$omp end parallel
                  ...
                  do a=1,nua; do b=1,nub; do c=b+1,nub;
                     if (.not. qspace(a,b,c)) cycle
                      do e = 1, nub
                         ...
                         resid(a,b,c) = resid(a,b,c) + H2C_vvov(e,c,b,k) * xbuf(e,a,j,i)
                         resid(a,b,c) = resid(a,b,c) - H2C_vvov(e,c,b,j) * xbuf(e,a,k,i)
                      end do
                   end do; end do; end do;
                   !$omp end do
                   !$omp end parallel
                   ...
                   do a=1,nua; do b=1,nub; do c=b+1,nub;
                     if (.not. qspace(a,b,c)) cycle
                      do m = 1, noa
                         ...
                         resid(a,b,c) = resid(a,b,c) - H2B_ovoo(m,b,i,j) * xbuf(m,k,a,c)
                         resid(a,b,c) = resid(a,b,c) + H2B_ovoo(m,c,i,j) * xbuf(m,k,a,b)
                         resid(a,b,c) = resid(a,b,c) + H2B_ovoo(m,b,i,k) * xbuf(m,j,a,c)
                         resid(a,b,c) = resid(a,b,c) - H2B_ovoo(m,c,i,k) * xbuf(m,j,a,b)
                      end do
                   end do; end do; end do;
                   !$omp end do
                   !$omp end parallel
                   ...
                   do a=1,nua; do b=1,nub; do c=b+1,nub;
                     if (.not. qspace(a,b,c)) cycle
                      do m = 1, nob
                         ...
                         resid(a,b,c) = resid(a,b,c) - H2B_vooo(m,a,i,j) * xbuf(m,k,b,c)
                         resid(a,b,c) = resid(a,b,c) + H2B_vooo(m,a,i,k) * xbuf(m,j,b,c)
                      end do
                   end do; end do; end do;
                   !$omp end do
                   !$omp end parallel
                   ...
                   do a=1,nua; do b=1,nub; do c=b+1,nub;
                     if (.not. qspace(a,b,c)) cycle
                      do m = 1, nob
                         ...
                         resid(a,b,c) = resid(a,b,c) - H2C_vooo(m,c,k,j) * xbuf(m,i,b,a)
                         resid(a,b,c) = resid(a,b,c) + H2C_vooo(m,b,k,j) * xbuf(m,i,c,a)
                      end do
                   end do; end do; end do;
                   !$omp end do
                   !$omp end parallel
              ...
              subroutine build_moments3d_ijk(resid, i, j, k,&
                  ...
                  do a=1,nub; do b=a+1,nub; do c=b+1,nub;
                     ...
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        ...
                        hmatel = hmatel + 0.5d0 * (hmatel1 + hmatel2 + hmatel3 + hmatel4)
                        resid(a,b,c) = resid(a,b,c) + hmatel * t3d_amps_copy(jdet)
                     end do
                     ! (ik)
                     idx = idx_table(a,b,c,i)
                     if (idx/=0) then
                 ...
                 !$omp do schedule(static)
                  do a=1,nub; do b=a+1,nub; do c=b+1,nub;
                    ...
                    do m = 1, nob
                       ...
                       resid(a,b,c) = resid(a,b,c) - H2C_vooo(m,a,i,j) * xbuf(m,k,b,c)
                       resid(a,b,c) = resid(a,b,c) + H2C_vooo(m,b,i,j) * xbuf(m,k,a,c)
                       resid(a,b,c) = resid(a,b,c) + H2C_vooo(m,c,i,j) * xbuf(m,k,b,a)
                       resid(a,b,c) = resid(a,b,c) + H2C_vooo(m,a,k,j) * xbuf(m,i,b,c)
                       resid(a,b,c) = resid(a,b,c) - H2C_vooo(m,b,k,j) * xbuf(m,i,a,c)
                       resid(a,b,c) = resid(a,b,c) - H2C_vooo(m,c,k,j) * xbuf(m,i,b,a)
                       resid(a,b,c) = resid(a,b,c) + H2C_vooo(m,a,i,k) * xbuf(m,j,b,c)
                       resid(a,b,c) = resid(a,b,c) - H2C_vooo(m,b,i,k) * xbuf(m,j,a,c)
                       resid(a,b,c) = resid(a,b,c) - H2C_vooo(m,c,i,k) * xbuf(m,j,b,a)
                    end do
                 end do; end do; end do;
                 !$omp end do
                 !$omp end parallel
                 ...
                 !$omp do schedule(static)
                  do a=1,nub; do b=a+1,nub; do c=b+1,nub;
                    ...
                    do e = 1, nub
                       ...
                       resid(a,b,c) = resid(a,b,c) + H2C_vvov(e,a,b,i) * t2c(e,c,j,k)
                       resid(a,b,c) = resid(a,b,c) - H2C_vvov(e,c,b,i) * t2c(e,a,j,k)
                       resid(a,b,c) = resid(a,b,c) - H2C_vvov(e,a,c,i) * t2c(e,b,j,k)
                       resid(a,b,c) = resid(a,b,c) - H2C_vvov(e,a,b,j) * t2c(e,c,i,k)
                       resid(a,b,c) = resid(a,b,c) + H2C_vvov(e,c,b,j) * t2c(e,a,i,k)
                       resid(a,b,c) = resid(a,b,c) + H2C_vvov(e,a,c,j) * t2c(e,b,i,k)
                       resid(a,b,c) = resid(a,b,c) - H2C_vvov(e,a,b,k) * t2c(e,c,j,i)
                       resid(a,b,c) = resid(a,b,c) + H2C_vvov(e,c,b,k) * t2c(e,a,j,i)
                       resid(a,b,c) = resid(a,b,c) + H2C_vvov(e,a,c,k) * t2c(e,b,j,i)
                    end do
                 end do; end do; end do;
                 !$omp end do
                 !$omp end parallel
        ...
        subroutine build_leftamps3d_ijk(resid, i, j, k,&
                  ...
                  do a=1,nub; do b=a+1,nub; do c=b+1,nub;
                     ...
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        ...
                        hmatel = hmatel + 0.5d0 * hmatel1
                        resid(a,b,c) = resid(a,b,c) + hmatel * l3d_amps_copy(jdet)
                     end do
                     ! (ik)
                     idx = idx_table(a,b,c,i)
                     if (idx/=0) then

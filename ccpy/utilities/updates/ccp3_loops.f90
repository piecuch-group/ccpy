module ccp3_loops
      ...
      contains
              ...
              subroutine crcc23A_p_full(deltaA,deltaB,deltaC,deltaD,&
                              pspace,&
                              MM23A,L3A,omega,&
              ...
              end subroutine crcc23A_p_full

              subroutine crcc23B_p_full(deltaA,deltaB,deltaC,deltaD,&
                              pspace,&
                              MM23B,L3B,omega,&
                              fA_oo,fA_vv,fB_oo,fB_vv,&
                              H1A_oo,H1A_vv,H1B_oo,H1B_vv,&
              ...
              end subroutine crcc23B_p_full

              subroutine crcc23C_p_full(deltaA,deltaB,deltaC,deltaD,&
                              pspace,&
                              MM23C,L3C,omega,&
                              fA_oo,fA_vv,fB_oo,fB_vv,&
                              H1A_oo,H1A_vv,H1B_oo,H1B_vv,&
              ...
              end subroutine crcc23C_p_full

              subroutine crcc23D_p_full(deltaA,deltaB,deltaC,deltaD,&
                              pspace,&
                              MM23D,L3D,omega,&

module ccp3_loops
      ...
      contains
              ...
              subroutine crcc23A_p(deltaA,deltaB,deltaC,deltaD,&
                              pspace,&
                              t2a,l1a,l2a,&
              ...
              end subroutine crcc23A_p

              subroutine crcc23B_p(deltaA,deltaB,deltaC,deltaD,&
                              pspace,&
              ...
              end subroutine crcc23B_p

              subroutine crcc23C_p(deltaA,deltaB,deltaC,deltaD,&
                              pspace,&
              ...
              end subroutine crcc23C_p

              subroutine crcc23D_p(deltaA,deltaB,deltaC,deltaD,&
                              pspace,&
                              t2c,l1b,l2c,&
              ...
              subroutine crcc23A_p_return_moment(deltaA,deltaB,deltaC,deltaD,&
                              mm23a,&
                              pspace,&
                              t2a,l1a,l2a,&
                              H2A_vooo,I2A_vvov,vA_oovv,H1A_ov,H2A_vovv,H2A_ooov,fA_oo,fA_vv,&
                        ...
                        real(kind=8), intent(out) :: deltaA, deltaB, deltaC, deltaD
                        integer, intent(in) :: noa, nua
                        real(kind=8), intent(out) :: mm23a(nua, nua, nua, noa, noa, noa)
                        integer, intent(in) :: pspace(nua, nua, nua, noa, noa, noa)
                        real(kind=8), intent(in) :: fA_oo(1:noa,1:noa),fA_vv(1:nua,1:nua),&
                        H1A_oo(1:noa,1:noa),H1A_vv(1:nua,1:nua),&
                        H2A_voov(1:nua,1:noa,1:noa,1:nua),&
              ...
              end subroutine crcc23A_p_return_moment

              subroutine crcc23B_p_return_moment(deltaA,deltaB,deltaC,deltaD,&
                              mm23b,&
                              pspace,&
                              t2a,t2b,l1a,l1b,l2a,l2b,&
                              I2B_ovoo,I2B_vooo,I2A_vooo,&
                        ...
                        real(kind=8), intent(out) :: deltaA, deltaB, deltaC, deltaD
                        integer, intent(in) :: noa, nua, nob, nub
                        real(kind=8), intent(out) :: mm23b(nua, nua, nub, noa, noa, nob)
                        integer, intent(in) :: pspace(nua, nua, nub, noa, noa, nob)
                        real(kind=8), intent(in) :: t2a(nua,nua,noa,noa),t2b(nua,nub,noa,nob),&
                        l1a(nua,noa),l1b(nub,nob),&
                        l2a(nua,nua,noa,noa),l2b(nua,nub,noa,nob),&
              ...
              end subroutine crcc23B_p_return_moment

              subroutine crcc23C_p_return_moment(deltaA,deltaB,deltaC,deltaD,&
                              mm23c,&
                              pspace,&
                              t2b,t2c,l1a,l1b,l2b,l2c,&
                              I2B_vooo,I2C_vooo,I2B_ovoo,&
                        ...
                        real(kind=8), intent(out) :: deltaA, deltaB, deltaC, deltaD
                        integer, intent(in) :: noa, nua, nob, nub
                        real(kind=8), intent(out) :: mm23c(nua, nub, nub, noa, nob, nob)
                        integer, intent(in) :: pspace(nua, nub, nub, noa, nob, nob)
                        real(kind=8), intent(in) :: t2b(nua,nub,noa,nob),&
                        t2c(nub,nub,nob,nob),l1a(nua,noa),l1b(nub,nob),&
                        l2b(nua,nub,noa,nob),l2c(nub,nub,nob,nob),&
              ...
              end subroutine crcc23C_p_return_moment

              subroutine crcc23D_p_return_moment(deltaA,deltaB,deltaC,deltaD,&
                              mm23d,&
                              pspace,&
                              t2c,l1b,l2c,&
                              H2C_vooo,I2C_vvov,vC_oovv,H1B_ov,H2C_vovv,H2C_ooov,fB_oo,fB_vv,&
                        ...
                        real(kind=8), intent(out) :: deltaA, deltaB, deltaC, deltaD
                        integer, intent(in) :: nob, nub
                        real(kind=8), intent(out) :: mm23d(nub, nub, nub, nob, nob, nob)
                        integer, intent(in) :: pspace(nub, nub, nub, nob, nob, nob)
                        real(kind=8), intent(in) :: fB_oo(1:nob,1:nob),fB_vv(1:nub,1:nub),&
                        H1B_oo(1:nob,1:nob),H1B_vv(1:nub,1:nub),&
                        H2C_voov(1:nub,1:nob,1:nob,1:nub),&
              ...
              end subroutine crcc23D_p_return_moment

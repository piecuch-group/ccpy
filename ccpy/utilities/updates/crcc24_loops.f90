module crcc24_loops
    ...
    contains
              ...
              subroutine crcc24A_opt(deltaA,deltaB,deltaC,deltaD,&
                        ...
                        real(kind=8) :: x4a(1:nua,1:nua,1:nua,1:nua), i1(1:nua,1:nua,1:noa)
                        real(kind=8) :: x4a2(1:nua,1:nua,1:nua,1:nua)
                            ...
                            do j = i+1, noa
                                do k = j+1, noa
                                    do l = k+1, noa
                                        ...
                                        !            = 12/16 A(abcd)[ -A(jl/i/k) i1(abm)_ijl * t2a(ebjl) ], where
                                        ! i1(abm)_ijl = h2a(amie) * t2a(ebjl)
                                        ! (1)
                                        call dgemm('n','n',nua*noa,nua,nua,1.0d0,h2a_voov(:,:,i,:),nua*noa,t2a(:,:,j,l),nua,0.0d0,i1,nua*noa)
                                        call dgemm('n','t',nua**2,nua**2,noa,-12.d0/24.d0,i1,nua**2,t2a(:,:,k,:),nua**2,1.0d0,x4a,nua**2)
!                                        do a1 = 1, nua
!                                            do b1 = 1, nua
!                                                do c1 = 1, nua
!                                                    do d1 = 1, nua
!                                                        x4a2(a1,b1,c1,d1) = x4a2(a1,b1,c1,d1)&
...
!                                        end do
                                        ! (ij)
                                        call dgemm('n','n',nua*noa,nua,nua,1.0d0,h2a_voov(:,:,j,:),nua*noa,t2a(:,:,i,l),nua,0.0d0,i1,nua*noa)
                                        call dgemm('n','t',nua**2,nua**2,noa,12.d0/24.d0,i1,nua**2,t2a(:,:,k,:),nua**2,1.0d0,x4a,nua**2)
                                        ! (jk)
                                        call dgemm('n','n',nua*noa,nua,nua,1.0d0,h2a_voov(:,:,i,:),nua*noa,t2a(:,:,k,l),nua,0.0d0,i1,nua*noa)
                                        call dgemm('n','t',nua**2,nua**2,noa,12.d0/24.d0,i1,nua**2,t2a(:,:,j,:),nua**2,1.0d0,x4a,nua**2)
                                        ! (il)
                                        call dgemm('n','n',nua*noa,nua,nua,1.0d0,h2a_voov(:,:,l,:),nua*noa,t2a(:,:,j,i),nua,0.0d0,i1,nua*noa)
                                        call dgemm('n','t',nua**2,nua**2,noa,12.d0/24.d0,i1,nua**2,t2a(:,:,k,:),nua**2,1.0d0,x4a,nua**2)
                                        ! (kl)
                                        call dgemm('n','n',nua*noa,nua,nua,1.0d0,h2a_voov(:,:,i,:),nua*noa,t2a(:,:,j,k),nua,0.0d0,i1,nua*noa)
                                        call dgemm('n','t',nua**2,nua**2,noa,12.d0/24.d0,i1,nua**2,t2a(:,:,l,:),nua**2,1.0d0,x4a,nua**2)
                                        ! (ij)(kl)
                                        call dgemm('n','n',nua*noa,nua,nua,1.0d0,h2a_voov(:,:,j,:),nua*noa,t2a(:,:,i,k),nua,0.0d0,i1,nua*noa)
                                        call dgemm('n','t',nua**2,nua**2,noa,-12.d0/24.d0,i1,nua**2,t2a(:,:,l,:),nua**2,1.0d0,x4a,nua**2)
                                        ! (ik)
                                        call dgemm('n','n',nua*noa,nua,nua,1.0d0,h2a_voov(:,:,k,:),nua*noa,t2a(:,:,j,l),nua,0.0d0,i1,nua*noa)
                                        call dgemm('n','t',nua**2,nua**2,noa,12.d0/24.d0,i1,nua**2,t2a(:,:,i,:),nua**2,1.0d0,x4a,nua**2)
                                        ! (ij)(ik)
                                        call dgemm('n','n',nua*noa,nua,nua,1.0d0,h2a_voov(:,:,j,:),nua*noa,t2a(:,:,k,l),nua,0.0d0,i1,nua*noa)
                                        call dgemm('n','t',nua**2,nua**2,noa,-12.d0/24.d0,i1,nua**2,t2a(:,:,i,:),nua**2,1.0d0,x4a,nua**2)
                                        ! (jk)(ik)
                                        call dgemm('n','n',nua*noa,nua,nua,1.0d0,h2a_voov(:,:,k,:),nua*noa,t2a(:,:,i,l),nua,0.0d0,i1,nua*noa)
                                        call dgemm('n','t',nua**2,nua**2,noa,-12.d0/24.d0,i1,nua**2,t2a(:,:,j,:),nua**2,1.0d0,x4a,nua**2)
                                        ! (il)(ik)
                                        call dgemm('n','n',nua*noa,nua,nua,1.0d0,h2a_voov(:,:,l,:),nua*noa,t2a(:,:,j,k),nua,0.0d0,i1,nua*noa)
                                        call dgemm('n','t',nua**2,nua**2,noa,-12.d0/24.d0,i1,nua**2,t2a(:,:,i,:),nua**2,1.0d0,x4a,nua**2)
                                        ! (kl)(ik)
                                        call dgemm('n','n',nua*noa,nua,nua,1.0d0,h2a_voov(:,:,k,:),nua*noa,t2a(:,:,j,i),nua,0.0d0,i1,nua*noa)
                                        call dgemm('n','t',nua**2,nua**2,noa,-12.d0/24.d0,i1,nua**2,t2a(:,:,l,:),nua**2,1.0d0,x4a,nua**2)
                                        ! (ij)(kl)(ik)
                                        call dgemm('n','n',nua*noa,nua,nua,1.0d0,h2a_voov(:,:,j,:),nua*noa,t2a(:,:,k,i),nua,0.0d0,i1,nua*noa)
                                        call dgemm('n','t',nua**2,nua**2,noa,12.d0/24.d0,i1,nua**2,t2a(:,:,l,:),nua**2,1.0d0,x4a,nua**2)
                                            ...
                                            do b = a+1, nua
                                                do c = b+1, nua
                                                    do d = c+1, nua
                                                        ...
                                                        ! antisymmetrize A(abcd) x4a(a,b,c,d)
                                                        mm24_v2 = x4a(a, b, c, d) + x4a(a, c, d, b) + x4a(a, d, b, c)&
                                                                 -x4a(a, b, d, c) - x4a(a, c, d, b) - x4a(a, d, c, b)&
              ...
              subroutine crcc24D(deltaA,deltaB,deltaC,deltaD,&
                              t2b,t2c,l2b,l2c,&
                              fA_oo,fA_vv,fB_oo,fB_vv,&
                              H1A_oo,H1A_vv,H1B_oo,H1B_vv,&
                              H2A_voov,&
              ...
              end subroutine crcc24D


              subroutine crcc24E(deltaA,deltaB,deltaC,deltaD,&
                              t2c,l2c,&
                              fB_oo,fB_vv,H1B_oo,H1B_vv,&
                              H2C_voov,H2C_oooo,H2C_vvvv,H2C_oovv,&
                              D3D_O,D3D_V,&
              ...
              end subroutine crcc24E

                !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! CC(P;4) 2BA P SPACE ROUTINES !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

              subroutine crcc24A_p(deltaA,deltaB,deltaC,deltaD,&
                              pspace_list_aaaa,&
                              t2a,l2a,&
                              fA_oo,fA_vv,H1A_oo,H1A_vv,&
                              H2A_voov,H2A_oooo,H2A_vvvv,H2A_oovv,&
                        ...
                        D3A_O(1:nua,1:noa,1:noa),&
                        D3A_V(1:nua,1:noa,1:nua)
                        integer, intent(in) :: pspace_list_aaaa(n4a, 8)

                        !real(kind=8), intent(in) :: test_array(1:nua,1:nua,1:nua,1:nua,1:noa,1:noa,1:noa,1:noa)

                        integer :: i, j, k, l, a, b, c, d, m, n, e, f, idet
                        real(kind=8) :: denom, temp, mm24, l4
                        ...
                        !error = 0.0d0
                        do idet = 1, n4a
                            a = pspace_list_aaaa(idet, 1)
                            b = pspace_list_aaaa(idet, 2)
                            c = pspace_list_aaaa(idet, 3)
                            d = pspace_list_aaaa(idet, 4)
                            i = pspace_list_aaaa(idet, 5)
                            j = pspace_list_aaaa(idet, 6)
                            k = pspace_list_aaaa(idet, 7)
                            l = pspace_list_aaaa(idet, 8)
              ...
              end subroutine crcc24A_p

              subroutine crcc24B_p(deltaA,deltaB,deltaC,deltaD,&
                              pspace_list_aaab,&
                              t2a,t2b,l2a,l2b,&
                              fA_oo,fA_vv,fB_oo,fB_vv,&
                              H1A_oo,H1A_vv,H1B_oo,H1B_vv,&
                        ...
                        real(kind=8), intent(out) :: deltaA, deltaB, deltaC, deltaD
                        integer, intent(in) :: noa, nua, nob, nub, n4b
                        real(kind=8), intent(in) :: t2a(1:nua,1:nua,1:noa,1:noa),t2b(1:nua,1:nub,1:noa,1:nob),&
                        l2a(1:nua,1:nua,1:noa,1:noa),l2b(1:nua,1:nub,1:noa,1:nob),&
                        fA_oo(1:noa,1:noa),fA_vv(1:nua,1:nua),fB_oo(1:nob,1:nob),fB_vv(1:nub,1:nub),&
                        H1A_oo(1:noa,1:noa),H1A_vv(1:nua,1:nua),H1B_oo(1:nob,1:nob),H1B_vv(1:nub,1:nub),&
                        ...
                        D3C_O(1:nub,1:noa,1:nob),&
                        D3C_V(1:nua,1:nob,1:nub)
                        integer, intent(in) :: pspace_list_aaab(n4b, 8)
                        ...
                        do idet = 1, n4b
                            ...
                            a = pspace_list_aaab(idet, 1)
                            b = pspace_list_aaab(idet, 2)
                            c = pspace_list_aaab(idet, 3)
                            d = pspace_list_aaab(idet, 4)
                            i = pspace_list_aaab(idet, 5)
                            j = pspace_list_aaab(idet, 6)
                            k = pspace_list_aaab(idet, 7)
                            l = pspace_list_aaab(idet, 8)
              ...
              end subroutine crcc24B_p

              subroutine crcc24C_p(deltaA,deltaB,deltaC,deltaD,&
                              pspace_list_aabb,&
                              t2a,t2b,t2c,l2a,l2b,l2c,&
                              fA_oo,fA_vv,fB_oo,fB_vv,&
                              H1A_oo,H1A_vv,H1B_oo,H1B_vv,&
                        ...
                        real(kind=8), intent(out) :: deltaA, deltaB, deltaC, deltaD
                        integer, intent(in) :: noa, nua, nob, nub, n4c
                        real(kind=8), intent(in) :: t2a(1:nua,1:nua,1:noa,1:noa),t2b(1:nua,1:nub,1:noa,1:nob),&
                        t2c(1:nub,1:nub,1:nob,1:nob),l2a(1:nua,1:nua,1:noa,1:noa),l2b(1:nua,1:nub,1:noa,1:nob),&
                        l2c(1:nub,1:nub,1:nob,1:nob),&
                        fA_oo(1:noa,1:noa),fA_vv(1:nua,1:nua),fB_oo(1:nob,1:nob),fB_vv(1:nub,1:nub),&
                        ...
                        D3D_O(1:nub,1:nob,1:nob),&
                        D3D_V(1:nub,1:nob,1:nub)
                        integer, intent(in) :: pspace_list_aabb(n4c, 8)
                        !real(kind=8), intent(in) :: test_array(1:nua,1:nua,1:nub,1:nub,1:noa,1:noa,1:nob,1:nob)
                        ...
                        do idet = 1, n4c
                            ...
                            a = pspace_list_aabb(idet, 1)
                            b = pspace_list_aabb(idet, 2)
                            c = pspace_list_aabb(idet, 3)
                            d = pspace_list_aabb(idet, 4)
                            i = pspace_list_aabb(idet, 5)
                            j = pspace_list_aabb(idet, 6)
                            k = pspace_list_aabb(idet, 7)
                            l = pspace_list_aabb(idet, 8)
              ...
              end subroutine crcc24C_p

              subroutine crcc24D_p(deltaA,deltaB,deltaC,deltaD,&
                              pspace_list_abbb,&
                              t2b,t2c,l2b,l2c,&
                              fA_oo,fA_vv,fB_oo,fB_vv,&
                              H1A_oo,H1A_vv,H1B_oo,H1B_vv,&
                        ...
                        real(kind=8), intent(out) :: deltaA, deltaB, deltaC, deltaD
                        integer, intent(in) :: noa, nua, nob, nub, n4d
                        real(kind=8), intent(in) :: t2c(1:nub,1:nub,1:nob,1:nob),t2b(1:nua,1:nub,1:noa,1:nob),&
                        l2c(1:nub,1:nub,1:nob,1:nob),l2b(1:nua,1:nub,1:noa,1:nob),&
                        fA_oo(1:noa,1:noa),fA_vv(1:nua,1:nua),fB_oo(1:nob,1:nob),fB_vv(1:nub,1:nub),&
                        H1A_oo(1:noa,1:noa),H1A_vv(1:nua,1:nua),H1B_oo(1:nob,1:nob),H1B_vv(1:nub,1:nub),&
                        ...
                        D3D_O(1:nub,1:nob,1:nob),&
                        D3D_V(1:nub,1:nob,1:nub)
                        integer, intent(in) :: pspace_list_abbb(n4d, 8)
                        !real(kind=8), intent(in) :: test_array(1:nua,1:nub,1:nub,1:nub,1:noa,1:nob,1:nob,1:nob)
                        ...
                        do idet = 1, n4d
                            ...
                            d = pspace_list_abbb(idet, 1)
                            a = pspace_list_abbb(idet, 2)
                            b = pspace_list_abbb(idet, 3)
                            c = pspace_list_abbb(idet, 4)
                            l = pspace_list_abbb(idet, 5)
                            i = pspace_list_abbb(idet, 6)
                            j = pspace_list_abbb(idet, 7)
                            k = pspace_list_abbb(idet, 8)
              ...
              end subroutine crcc24D_p


              subroutine crcc24E_p(deltaA,deltaB,deltaC,deltaD,&
                              pspace_list_bbbb,&
                              t2c,l2c,&
                              fB_oo,fB_vv,H1B_oo,H1B_vv,&
                              H2C_voov,H2C_oooo,H2C_vvvv,H2C_oovv,&
                        ...
                        D3D_O(1:nub,1:nob,1:nob),&
                        D3D_V(1:nub,1:nob,1:nub)
                        integer, intent(in) :: pspace_list_bbbb(n4e, 8)
                        !real(kind=8), intent(in) :: test_array(1:nub,1:nub,1:nub,1:nub,1:nob,1:nob,1:nob,1:nob)
                        ...
                        do idet = 1, n4e
                            ...
                            a = pspace_list_bbbb(idet, 1)
                            b = pspace_list_bbbb(idet, 2)
                            c = pspace_list_bbbb(idet, 3)
                            d = pspace_list_bbbb(idet, 4)
                            i = pspace_list_bbbb(idet, 5)
                            j = pspace_list_bbbb(idet, 6)
                            k = pspace_list_bbbb(idet, 7)
                            l = pspace_list_bbbb(idet, 8)

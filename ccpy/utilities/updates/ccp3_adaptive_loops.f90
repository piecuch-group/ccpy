    ...
    implicit none
            ...
            contains
              ...
              subroutine ccp3a_2ba_with_selection_opt(deltaA,deltaB,deltaC,deltaD,&
                        ...
                        real(kind=8), intent(inout) :: moments(2*num_add)
                        !f2py intent(in,out) :: moments(0:2*num_add-1)
                        integer, intent(inout) :: triples_list(2*num_add,6)
                        !f2py intent(in,out) :: triples_list(0:2*num_add-1,0:5)
                        integer, intent(inout) :: nfill
                        !f2py intent(in,out) :: nfill

                        integer :: i, j, k, a, b, c, nua2, isort(2*num_add)
                                        ...
                                        do b = a+1, nua
                                            do c = b+1, nua
                                                ...
                                                if (nfill <= 2*num_add) then
                                                   ...
                                                   call argsort_r8(abs(moments),isort)
                                                   moments = moments(isort(2*num_add:1:-1))
                                                   triples_list = triples_list(isort(2*num_add:1:-1),:)
                                                   minval = abs(moments(num_add))
                                                   nfill = num_add + 1
                                                end if
                                            end do
              ...
              subroutine ccp3b_2ba_with_selection_opt(deltaA,deltaB,deltaC,deltaD,&
                        ...
                        integer :: i, j, k, a, b, c, nuanub, nua2, isort(2*num_add)
              ...
              subroutine ccp3c_2ba_with_selection_opt(deltaA,deltaB,deltaC,deltaD,&
                        ...
                        integer :: i, j, k, a, b, c, nuanub, nub2, isort(2*num_add)
              ...
              subroutine ccp3d_2ba_with_selection_opt(deltaA,deltaB,deltaC,deltaD,&
                        ...
                        integer :: i, j, k, a, b, c, nub2, isort(2*num_add)

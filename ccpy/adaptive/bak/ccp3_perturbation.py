...
def ccp3_pertT(cc_t, p_spaces, ints, sys, flag_RHF=False):
    ...
    print(
        "CCSD(T) = {} Eh     Ecorr(T) = {} Eh     Delta = {} Eh".format(
            Eparenth, Ecorr + delta, delta
        )
    )

...
def ccsdt_p(
    ...
    while it_micro < maxit:
        ...
        if num_triples_A > 0:
            ...
            cc_t["t3a"] = ccp_loops.ccp_loops.update_t3a(
                cc_t["t2a"],
                cc_t["t3a"],
                cc_t["t3b"],
                list_A,
        ...
        if num_triples_B > 0:
            ...
            cc_t["t3b"] = ccp_loops.ccp_loops.update_t3b(
                cc_t["t2a"],
                cc_t["t2b"],
                cc_t["t3a"],
                cc_t["t3b"],
        ...
        if num_triples_C > 0:
            ...
            cc_t["t3c"] = ccp_loops.ccp_loops.update_t3c(
                cc_t["t2b"],
                cc_t["t2c"],
                cc_t["t3b"],
                cc_t["t3c"],
        ...
        if num_triples_D > 0:
            ...
            cc_t["t3d"] = ccp_loops.ccp_loops.update_t3d(
                cc_t["t2c"],
                cc_t["t3c"],
                cc_t["t3d"],
                list_D,
        ...
        print(
            "   {}       {:.10f}          {:.10f}          {:.10f}         ({:.3f}s)".format(
                it_micro, resid, deltaE, Ecorr, t_iter_end - t_iter_start
            )
        )
...
def update_t2a(cc_t, ints, H1A, H1B, H2A, H2B, H2C, sys, shift):
    ...
    D56 = (
        D56
        - np.einsum("abij->baij", D56, optimize=True)
        - np.einsum("abij->abji", D56, optimize=True)
        + np.einsum("abij->baji", D56, optimize=True)
    )

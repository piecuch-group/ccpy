...
def build_hbar_ccsd(T, H0, RHF_symmetry, *args):
    ...
    Q2 = -H0.aa.voov - 0.5 * ccpy_einsum("mnie,bn->bmie", H0.aa.ooov, T.a)
    Q2 = -ccpy_einsum("bmie,am->abie", Q2, T.a)
    Q1 += Q2
    Q1 -= np.transpose(Q1, (1, 0, 2, 3))
    H.aa.vvov += Q1 + (
    ...
    Q2 = -H0.bb.voov - 0.5 * ccpy_einsum("mnie,bn->bmie", H0.bb.ooov, T.b)
    Q2 = -ccpy_einsum("bmie,am->abie", Q2, T.b)
    Q1 += Q2
    Q1 -= np.transpose(Q1, (1, 0, 2, 3))
    H.bb.vvov += Q1 + (

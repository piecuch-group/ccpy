...
# def build_s2_cisd(system, nacto, nactu):
#
...
#
#     idx_a, idx_b, idx_aa, idx_ab, idx_bb = get_index_arrays(nacto, nactu, system, target_irrep=None)
#
#     sz2 = get_sz2(system, Ms=0)
#     ####################################################################################
#     # ALPHA SINGLES
...
#     for a in range(system.noccupied_alpha, system.noccupied_alpha + system.nunoccupied_alpha):
#         for i in range(system.noccupied_alpha):
#             idet = idx_a[a - system.noccupied_alpha, i]
#             I = abs(idet) - 1
#             #
#
#
...
def get_index_arrays(nacto, nactu, system, target_irrep=None):

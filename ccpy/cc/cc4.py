...
def update(T, dT, H, hbar, shift, flag_RHF, system):
    ...
    X = get_cc4_intermediates(T, H)
    # Build the CC4 T4
    t4 = compute_t4(T, X, H, flag_RHF)
    # t4["aaaa"] *= 0.0
    # t4["aaab"] *= 0.0
    # t4["aabb"] *= 0.0
    # t4["abbb"] *= 0.0
    ...
    # update T2
    T, dT = update_t2a(T, t4, dT, hbar, H, shift)
    T, dT = update_t2b(T, t4, dT, hbar, H, shift)
    if flag_RHF:
        T.bb = T.aa.copy()
        dT.bb = dT.aa.copy()
    else:
        T, dT = update_t2c(T, t4, dT, hbar, H, shift)
    ...
    # update T3
    T, dT = update_t3a(T, t4, dT, hbar, H, shift)
    T, dT = update_t3b(T, t4, dT, hbar, H, shift)
    if flag_RHF:
        ...
        T, dT = update_t3c(T, t4, dT, hbar, H, shift)
        T, dT = update_t3d(T, t4, dT, hbar, H, shift)

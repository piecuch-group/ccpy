...
def update_t1a(T, dT, H, shift, t3_excitations):
    ...
    T.a, dT.a = ccp_linear_loops.ccp_linear_loops.update_t1a(
        T.a, 
        dT.a + H.a.vo,
...
def update_t1b(T, dT, H, shift, t3_excitations):
    ...
    T.b, dT.b = ccp_linear_loops.ccp_linear_loops.update_t1b(
        T.b,
        dT.b + H.b.vo,
...
def update_t2a(T, dT, H, H0, shift, t3_excitations):
    ...
    T.aa, dT.aa = ccp_linear_loops.ccp_linear_loops.update_t2a(
        T.aa,
...
def update_t2b(T, dT, H, H0, shift, t3_excitations):
    ...
    T.ab, dT.ab = ccp_linear_loops.ccp_linear_loops.update_t2b(
        T.ab,
        dT.ab + H0.ab.vvoo,
...
def update_t2c(T, dT, H, H0, shift, t3_excitations):
    ...
    T.bb, dT.bb = ccp_linear_loops.ccp_linear_loops.update_t2c(
        T.bb,
...
def update_t3a(T, dT, H, H0, shift, t3_excitations):
    ...
    T.aaa, dT.aaa = ccp_linear_loops.ccp_linear_loops.update_t3a_p(
        T.aaa,
        t3_excitations["aaa"], t3_excitations["aab"],
        T.aa,
        T.aab,
...
def update_t3b(T, dT, H, H0, shift, t3_excitations):
    ...
    T.aab, dT.aab = ccp_linear_loops.ccp_linear_loops.update_t3b_p(
        T.aab,
        t3_excitations["aaa"], t3_excitations["aab"], t3_excitations["abb"],
        T.aa, T.ab,
        T.aaa, T.abb,
...
def update_t3c(T, dT, H, H0, shift, t3_excitations):
    ...
    T.abb, dT.abb = ccp_linear_loops.ccp_linear_loops.update_t3c_p(
        T.abb,
        t3_excitations["aab"], t3_excitations["abb"], t3_excitations["bbb"],
        T.ab, T.bb,
        T.aab, T.bbb,
...
def update_t3d(T, dT, H, H0, shift, t3_excitations):
    ...
    T.bbb, dT.bbb = ccp_linear_loops.ccp_linear_loops.update_t3d_p(
        T.bbb,
        t3_excitations["abb"], t3_excitations["bbb"],
        T.bb,
        T.abb,

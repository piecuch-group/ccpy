...
from ccpy.utilities.updates import ccp_quadratic_loops_omp
...
def update(T, dT, H, shift, flag_RHF, system, t3_excitations, pspace):
    ...
    # update T3
    if do_t3["aaa"]:
        T, dT = update_t3a(T, dT, hbar, H, shift, t3_excitations, pspace)
    if do_t3["aab"]:
...
def update_t1a(T, dT, H, shift, t3_excitations):
    ...
    T.a, dT.a = ccp_quadratic_loops_omp.ccp_quadratic_loops_omp.update_t1a(
        T.a, 
        dT.a + H.a.vo,
...
def update_t1b(T, dT, H, shift, t3_excitations):
    ...
    T.b, dT.b = ccp_quadratic_loops_omp.ccp_quadratic_loops_omp.update_t1b(
        T.b,
        dT.b + H.b.vo,
...
def update_t2a(T, dT, H, H0, shift, t3_excitations):
    ...
    T.aa, dT.aa = ccp_quadratic_loops_omp.ccp_quadratic_loops_omp.update_t2a(
        T.aa,
...
def update_t2b(T, dT, H, H0, shift, t3_excitations):
    ...
    T.ab, dT.ab = ccp_quadratic_loops_omp.ccp_quadratic_loops_omp.update_t2b(
        T.ab,
        dT.ab + H0.ab.vvoo,
...
def update_t2c(T, dT, H, H0, shift, t3_excitations):
    ...
    T.bb, dT.bb = ccp_quadratic_loops_omp.ccp_quadratic_loops_omp.update_t2c(
        T.bb,
...
# @profile
def update_t3a(T, dT, H, H0, shift, t3_excitations, pspace):
    """
    ...
    T.aaa, dT.aaa = ccp_quadratic_loops_omp.ccp_quadratic_loops_omp.update_t3a_p(
        T.aaa,
        t3_excitations["aaa"].T, t3_excitations["aab"].T,
        pspace["aaa"],
        T.aa,
...
def update_t3b(T, dT, H, H0, shift, t3_excitations, pspace):
    ...
    T.aab, dT.aab = ccp_quadratic_loops_omp.ccp_quadratic_loops_omp.update_t3b_p(
        T.aab,
        t3_excitations["aaa"].T, t3_excitations["aab"].T, t3_excitations["abb"].T,
        pspace["aab"],
        T.aa, T.ab,
...
def update_t3c(T, dT, H, H0, shift, t3_excitations, pspace):
    ...
    T.abb, dT.abb = ccp_quadratic_loops_omp.ccp_quadratic_loops_omp.update_t3c_p(
        T.abb,
        t3_excitations["aab"].T, t3_excitations["abb"].T, t3_excitations["bbb"].T,
        pspace["abb"],
        T.ab, T.bb,
...
def update_t3d(T, dT, H, H0, shift, t3_excitations, pspace):
    ...
    T.bbb, dT.bbb = ccp_quadratic_loops_omp.ccp_quadratic_loops_omp.update_t3d_p(
        T.bbb,
        t3_excitations["abb"].T, t3_excitations["bbb"].T,
        pspace["bbb"],
        T.bb,

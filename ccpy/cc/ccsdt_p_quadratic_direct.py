...
def update_t1a(T, dT, H, shift, t3_excitations):
    ...
    T.a, dT.a = ccp_quadratic_loops_direct.ccp_quadratic_loops_direct.update_t1a(
        T.a, 
        dT.a + H.a.vo,
...
def update_t1b(T, dT, H, shift, t3_excitations):
    ...
    T.b, dT.b = ccp_quadratic_loops_direct.ccp_quadratic_loops_direct.update_t1b(
        T.b,
        dT.b + H.b.vo,
...
def update_t2a(T, dT, H, H0, shift, t3_excitations):
    ...
    T.aa, dT.aa = ccp_quadratic_loops_direct.ccp_quadratic_loops_direct.update_t2a(
        T.aa,
...
def update_t2b(T, dT, H, H0, shift, t3_excitations):
    ...
    T.ab, dT.ab = ccp_quadratic_loops_direct.ccp_quadratic_loops_direct.update_t2b(
        T.ab,
        dT.ab + H0.ab.vvoo,
...
def update_t2c(T, dT, H, H0, shift, t3_excitations):
    ...
    T.bb, dT.bb = ccp_quadratic_loops_direct.ccp_quadratic_loops_direct.update_t2c(
        T.bb,

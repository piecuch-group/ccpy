      ...
      contains
               ...
               subroutine build_hr_1a(x1a,&
                      ...
                      do idet = 1, n3aaa
                          ...
                          i = r3a_excits(idet,4); m = r3a_excits(idet,5); n = r3a_excits(idet,6);
                      ...
                      do idet = 1, n3aab
                          ...
                          i = r3b_excits(idet,4); m = r3b_excits(idet,5); n = r3b_excits(idet,6);
                      ...
                      do idet = 1, n3abb
                          ...
                          i = r3c_excits(idet,4); m = r3c_excits(idet,5); n = r3c_excits(idet,6);
              ...
              subroutine build_hr_2a(sigma_2a,&
                  ...
                  integer, intent(in) :: r3a_excits(n3aaa_r,6), r3b_excits(n3aab_r,6)
                  integer, intent(in) :: t3a_excits(n3aaa_t,6), t3b_excits(n3aab_t,6) 
                  ...
                  do idet = 1, n3aaa_r
                      ...
                      i = r3a_excits(idet,4); j = r3a_excits(idet,5); m = r3a_excits(idet,6);
                      ...
                      m = r3a_excits(idet,4); j = r3a_excits(idet,5); n = r3a_excits(idet,6);
                      ...
                      e = r3a_excits(idet,1); b = r3a_excits(idet,2); f = r3a_excits(idet,3);
                      i = r3a_excits(idet,4); j = r3a_excits(idet,5); n = r3a_excits(idet,6);
                  ...
                  do idet = 1, n3aab_r
                      ...
                      i = r3b_excits(idet,4); j = r3b_excits(idet,5); m = r3b_excits(idet,6);
                      ...
                      m = r3b_excits(idet,4); j = r3b_excits(idet,5); n = r3b_excits(idet,6);
                      ...
                      e = r3b_excits(idet,1); b = r3b_excits(idet,2); f = r3b_excits(idet,3);
                      i = r3b_excits(idet,4); j = r3b_excits(idet,5); n = r3b_excits(idet,6);
              ...
              subroutine build_hr_3a(resid,&
                  ...
                  integer, intent(in) :: r3b_excits(n3aab_r,6), t3b_excits(n3aab_t,6)
                  ...
                  do idet = 1, n3aaa_r
                     ...
                     i = r3a_excits(idet,4); j = r3a_excits(idet,5); k = r3a_excits(idet,6);
                     ! (1)
                     idx = idx_table(a,b,c,k)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        l = r3a_excits(jdet,4); m = r3a_excits(jdet,5);
                  ...
                  do idet = 1, n3aaa_r
                     ...
                     idx = idx_table(a,b,c,i)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        m = r3a_excits(jdet,5); n = r3a_excits(jdet,6);
                  ...
                  do idet = 1, n3aaa_r
                     ...
                     idx = idx_table(a,b,c,j)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        l = r3a_excits(jdet,4); n = r3a_excits(jdet,6);
                  ...
                  do idet = 1, n3aaa_r
                     ...
                     if (idx/=0) then
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        f = r3a_excits(jdet,3); n = r3a_excits(jdet,6);
                  ...
                  do idet = 1, n3aaa_r
                     ...
                     if (idx/=0) then
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        e = r3a_excits(jdet,2); n = r3a_excits(jdet,6);
                  ...
                  do idet = 1, n3aaa_r
                     ...
                     if (idx/=0) then
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        d = r3a_excits(jdet,1); n = r3a_excits(jdet,6);
                  ...
                  do idet = 1, n3aaa_r
                     ...
                     if (idx/=0) then
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        f = r3a_excits(jdet,3); m = r3a_excits(jdet,5);
                  ...
                  do idet = 1, n3aaa_r
                     ...
                     if (idx/=0) then
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        e = r3a_excits(jdet,2); m = r3a_excits(jdet,5);
                  ...
                  do idet = 1, n3aaa_r
                     ...
                     if (idx/=0) then
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        d = r3a_excits(jdet,1); m = r3a_excits(jdet,5);
                  ...
                  do idet = 1, n3aaa_r
                     ...
                     if (idx/=0) then
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        f = r3a_excits(jdet,3); l = r3a_excits(jdet,4);
                  ...
                  do idet = 1, n3aaa_r
                     ...
                     if (idx/=0) then
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        e = r3a_excits(jdet,2); l = r3a_excits(jdet,4);
                  ...
                  do idet = 1, n3aaa_r
                     ...
                     if (idx/=0) then
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        d = r3a_excits(jdet,1); l = r3a_excits(jdet,4);
                  ...
                  allocate(amps_buff(n3aab_r),excits_buff(n3aab_r,6))
                  amps_buff(:) = r3b_amps(:)
                  ...
                  allocate(excits_buff(n3aaa_t,6))
                  amps_buff(:) = t3a_amps(:)
              ...
              subroutine build_hr_3b(resid,&
                  ...
                  integer, intent(in) :: r3a_excits(n3aaa_r,6), t3a_excits(n3aaa_t,6)
                  ...
                  do idet = 1, n3aab_r
                     ...
                     i = r3b_excits(idet,4); j = r3b_excits(idet,5); k = r3b_excits(idet,6);
                     idx = idx_table(a,b,c,k)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        l = r3b_excits(jdet,4); m = r3b_excits(jdet,5);
                  ...
                  do idet = 1, n3aab_r
                     ...
                     idx = idx_table(a,b,c,i)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        m = r3b_excits(jdet,5); n = r3b_excits(jdet,6);
                  ...
                  do idet = 1, n3aab_r
                     ...
                     idx = idx_table(a,b,c,j)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        l = r3b_excits(jdet,4); n = r3b_excits(jdet,6);
...
!                  print*, "R3B - diagrams 5/8 = ", ttoc - ttic, "Diagram time =", dtime, "Sort time = ", stime
                  ...
                  do idet = 1, n3aab_r
                     ...
                     idx = idx_table(b,c,j,k)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        d = r3b_excits(jdet,1); l = r3b_excits(jdet,4);
                  ...
                  do idet = 1, n3aab_r
                     ...
                     idx = idx_table(b,c,i,k)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        d = r3b_excits(jdet,1); l = r3b_excits(jdet,5);
                  ...
                  do idet = 1, n3aab_r
                     ...
                     idx = idx_table(a,c,i,k)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        d = r3b_excits(jdet,2); l = r3b_excits(jdet,5);
                  ...
                  do idet = 1, n3aab_r
                     ...
                     idx = idx_table(a,c,j,k)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        d = r3b_excits(jdet,2); l = r3b_excits(jdet,4);
                  ...
                  do idet = 1, n3aab_r
                     ...
                     idx = idx_table(a,c,i,k)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        d = excits_buff(jdet,2); l = excits_buff(jdet,5);
                        ! compute < ijk~abc~ | h2a(voov) | ilk~adc~  >
                        !hmatel = x2a_voov(b,l,j,d)
                        hmatel = x2a_voov(l,d,b,j)
                        resid(idet) = resid(idet) + hmatel * amps_buff(jdet)
                  ...
                  do idet = 1, n3aab_r
                     ...
                     idx = idx_table(a,c,j,k)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        d = excits_buff(jdet,2); l = excits_buff(jdet,4);
                        ! compute < ijk~abc~ | h2a(voov) | ljk~adc~  >
                        !hmatel = x2a_voov(b,l,i,d)
                        hmatel = x2a_voov(l,d,b,i)
                        resid(idet) = resid(idet) + hmatel * amps_buff(jdet)
                  ...
                  do idet = 1, n3aab_r
                      ...
                      idx = idx_table(a,b,i,j)
                      do jdet = loc_arr(1,idx), loc_arr(2,idx)
                         f = r3b_excits(jdet,3); n = r3b_excits(jdet,6);
                  ...
                  do idet = 1, n3aab_r
                     ...
                     idx = idx_table(a,b,i,k)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        f = r3b_excits(jdet,3); m = r3b_excits(jdet,5);
                  ...
                  do idet = 1, n3aab_r
                     ...
                     idx = idx_table(a,b,j,k)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        f = r3b_excits(jdet,3); l = r3b_excits(jdet,4);
                  ...
                  do idet = 1, n3aab_r
                     ...
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        d = r3b_excits(jdet,1); n = r3b_excits(jdet,6);
                  ...
                  do idet = 1, n3aab_r
                     ...
                     idx = idx_table(i,j,a,c)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        e = r3b_excits(jdet,2); n = r3b_excits(jdet,6);
                  ...
                  allocate(excits_buff(n3aaa_r,6))
                  amps_buff(:) = r3a_amps(:)
                  ...
                  allocate(excits_buff(n3abb_r,6))
                  amps_buff(:) = r3c_amps(:)
                  ...
                  allocate(excits_buff(n3abb_t,6))
                  amps_buff(:) = t3c_amps(:)
              ...
              subroutine build_hr_3c(resid,&
                  ...
                  call sort4(r3c_excits, r3c_amps, loc_arr, idx_table, (/2,3,1,4/), nub, nub, nua, noa, nloc, n3abb_r, resid)
                  !!!! BEGIN OMP PARALLEL SECTION !!!!
                  !$omp parallel shared(resid,&
                  !$omp r3c_excits,&
                  !$omp r3c_amps,&
                  ...
                  do idet = 1, n3abb_r
                     ...
                     i = r3c_excits(idet,4); j = r3c_excits(idet,5); k = r3c_excits(idet,6);
                     idx = idx_table(b,c,a,i)
                     ! (1)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        m = r3c_excits(jdet,5); n = r3c_excits(jdet,6);
                  ...
                  !!! BCAI LOOP !!!
                  ! allocate temporary arrays
                  allocate(excits_buff(n3abb_t,6),amps_buff(n3abb_t))
                  excits_buff(:,:) = t3c_excits(:,:)
                  amps_buff(:) = t3c_amps(:)
                  ! allocate new sorting arrays
                  nloc = nub*(nub-1)/2*nua*noa
                  ...
                  do idet = 1, n3abb_r
                     ...
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        l = r3c_excits(jdet,4); m = r3c_excits(jdet,5);
                  ...
                  do idet = 1, n3abb_r
                     ...
                     idx = idx_table(b,c,a,j)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        l = r3c_excits(jdet,4); n = r3c_excits(jdet,6);
                  ...
                  do idet = 1, n3abb_r
                     ...
                     idx = idx_table(a,b,i,j)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        f = r3c_excits(jdet,3); n = r3c_excits(jdet,6);
                  ...
                  do idet = 1, n3abb_r
                      ...
                      idx = idx_table(a,c,i,j)
                      do jdet = loc_arr(1,idx), loc_arr(2,idx)
                          e = r3c_excits(jdet,2); n = r3c_excits(jdet,6);
                  ...
                  do idet = 1, n3abb_r
                      ...
                      idx = idx_table(a,b,i,k)
                      do jdet = loc_arr(1,idx), loc_arr(2,idx)
                          f = r3c_excits(jdet,3); m = r3c_excits(jdet,5);
                  ...
                  do idet = 1, n3abb_r
                      ...
                      idx = idx_table(a,c,i,k)
                      do jdet = loc_arr(1,idx), loc_arr(2,idx)
                          e = r3c_excits(jdet,2); m = r3c_excits(jdet,5);
                  ...
                  do idet = 1, n3abb_r
                      ...
                      idx = idx_table(b,c,j,k)
                      do jdet = loc_arr(1,idx), loc_arr(2,idx)
                         d = r3c_excits(jdet,1); l = r3c_excits(jdet,4);
                  ...
                  do idet = 1, n3abb_r
                      ...
                      do jdet = loc_arr(1,idx), loc_arr(2,idx)
                          e = r3c_excits(jdet,2); l = r3c_excits(jdet,4);
                  ...
                  do idet = 1, n3abb_r
                      ...
                      idx = idx_table(j,k,a,b)
                      do jdet = loc_arr(1,idx), loc_arr(2,idx)
                          f = r3c_excits(jdet,3); l = r3c_excits(jdet,4);
                  ...
                  do idet = 1, n3abb_r
                      ...
                      idx = idx_table(b,c,i,k)
                      do jdet = loc_arr(1,idx), loc_arr(2,idx)
                          d = r3c_excits(jdet,1); m = r3c_excits(jdet,5);
                  ...
                  do idet = 1, n3abb_r
                      ...
                      idx = idx_table(b,c,i,j)
                      do jdet = loc_arr(1,idx), loc_arr(2,idx)
                          d = r3c_excits(jdet,1); n = r3c_excits(jdet,6);
                  ...
                  allocate(excits_buff(n3bbb_r,6))
                  amps_buff(:) = r3d_amps(:)
                  ...
                  allocate(excits_buff(n3bbb_t,6))
                  amps_buff(:) = t3d_amps(:)
                  ...
                  allocate(excits_buff(n3aab_r,6))
                  amps_buff(:) = r3b_amps(:)
                  excits_buff(:,:) = r3b_excits(:,:)
                  ! allocate sorting arrays (can be reused for each permutation)
                  nloc = nua*nub*noa*nob
                  ...
                  allocate(excits_buff(n3aab_t,6))
                  amps_buff(:) = t3b_amps(:)
                  excits_buff(:,:) = t3b_excits(:,:)
                  ! allocate sorting arrays (can be reused for each permutation)
                  nloc = nua*nub*noa*nob
              ...
              subroutine build_hr_3d(resid,&
                  ...
                  !$omp do schedule(static)
                  do idet = 1, n3bbb_r
                     a = r3d_excits(idet,1); b = r3d_excits(idet,2); c = r3d_excits(idet,3);
                     i = r3d_excits(idet,4); j = r3d_excits(idet,5); k = r3d_excits(idet,6);
                     ! (1)
                     idx = idx_table(a,b,c,k)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        l = r3d_excits(jdet,4); m = r3d_excits(jdet,5);
                  ...
                  do idet = 1, n3bbb_r
                     ...
                     idx = idx_table(a,b,c,i)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        m = r3d_excits(jdet,5); n = r3d_excits(jdet,6);
                  ...
                  do idet = 1, n3bbb_r
                     ...
                     idx = idx_table(a,b,c,j)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        l = r3d_excits(jdet,4); n = r3d_excits(jdet,6);
                  ...
                  ! allocate temporary arrays
                  allocate(excits_buff(n3bbb_t,6),amps_buff(n3bbb_t))
                  excits_buff(:,:) = t3d_excits(:,:)
                  amps_buff(:) = t3d_amps(:)
                  ! allocate new sorting arrays
                  nloc = nub*(nub-1)*(nub-2)/6*nob
                  ...
                  do idet = 1, n3bbb_r
                     ...
                     idx = idx_table(i,j,k,a)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        e = r3d_excits(jdet,2); f = r3d_excits(jdet,3);
                  ...
                  do idet = 1, n3bbb_r
                     ...
                     idx = idx_table(i,j,k,b)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        d = r3d_excits(jdet,1); f = r3d_excits(jdet,3);
                  ...
                  do idet = 1, n3bbb_r
                     ...
                     idx = idx_table(i,j,k,c)
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        d = r3d_excits(jdet,1); e = r3d_excits(jdet,2);
                  ...
                  do idet = 1, n3bbb_r
                     ...
                     if (idx/=0) then
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        f = r3d_excits(jdet,3); n = r3d_excits(jdet,6);
                  ...
                  do idet = 1, n3bbb_r
                     ...
                     if (idx/=0) then
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        e = r3d_excits(jdet,2); n = r3d_excits(jdet,6);
                  ...
                  do idet = 1, n3bbb_r
                     ...
                     if (idx/=0) then
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        d = r3d_excits(jdet,1); n = r3d_excits(jdet,6);
                  ...
                  do idet = 1, n3bbb_r
                     ...
                     if (idx/=0) then
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        f = r3d_excits(jdet,3); m = r3d_excits(jdet,5);
                  ...
                  do idet = 1, n3bbb_r
                     ...
                     if (idx/=0) then
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        e = r3d_excits(jdet,2); m = r3d_excits(jdet,5);
                  ...
                  do idet = 1, n3bbb_r
                     ...
                     if (idx/=0) then
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        d = r3d_excits(jdet,1); m = r3d_excits(jdet,5);
                  ...
                  do idet = 1, n3bbb_r
                     ...
                     if (idx/=0) then
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        f = r3d_excits(jdet,3); l = r3d_excits(jdet,4);
                  ...
                  do idet = 1, n3bbb_r
                     ...
                     if (idx/=0) then
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        e = r3d_excits(jdet,2); l = r3d_excits(jdet,4);
                  ...
                  do idet = 1, n3bbb_r
                     ...
                     if (idx/=0) then
                     do jdet = loc_arr(1,idx), loc_arr(2,idx)
                        d = r3d_excits(jdet,1); l = r3d_excits(jdet,4);
                  ...
                  allocate(amps_buff(n3abb_r),excits_buff(n3abb_r,6))
                  amps_buff(:) = r3c_amps(:)
                  excits_buff(:,:) = r3c_excits(:,:)
                  ! allocate sorting arrays (can be reused for each permutation)
                  nloc = nub*(nub-1)/2*nob*(nob-1)/2

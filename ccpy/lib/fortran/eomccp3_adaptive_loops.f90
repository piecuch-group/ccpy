module eomccp3_adaptive_loops
  ...
  use reorder, only: reorder_stripe
    ...
    contains
               subroutine creomcc23A_p_with_selection(deltaA,deltaB,deltaC,deltaD,&
                              moments,&
                              triples_list,&
                              pspace,&
              ...
              end subroutine creomcc23A_p_with_selection

              subroutine creomcc23B_p_with_selection(deltaA,deltaB,deltaC,deltaD,&
                              moments,&
                              triples_list,&
                              pspace,&
                              omega,r0,&
              ...
              end subroutine creomcc23B_p_with_selection

              subroutine creomcc23C_p_with_selection(deltaA,deltaB,deltaC,deltaD,&
                              moments,&
                              triples_list,&
                              pspace,&
                              omega,r0,&
              ...
              end subroutine creomcc23C_p_with_selection

              subroutine creomcc23D_p_with_selection(deltaA,deltaB,deltaC,deltaD,&
                              moments,&
                              triples_list,&
                              pspace,&
                              omega,r0,&

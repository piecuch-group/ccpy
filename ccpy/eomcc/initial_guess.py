...
def build_eomccsd_matrix(dets1A,dets1B,dets2A,dets2B,dets2C,H1A,H1B,H2A,H2B,H2C):
    ...
    for idet in range(n1a):
        ...
        for jdet in range(n1a):
            ...
            H1A1A[idet,jdet] = (i==j)*H1A['vv'][a,b]-(a==b)*H1A['oo'][j,i]\
                            +H2A['voov'][a,j,i,b]
    # 1A - 1B block
    ...
    for idet in range(n1b):
        ...
        for jdet in range(n1b):
            j,b = dets1B['inds'][jdet]
            sym2 = dets1B['sym'][jdet]
            H1B1B[idet,jdet] = (i==j)*H1B['vv'][a,b]-(a==b)*H1B['oo'][j,i]\
                            +H2C['voov'][a,j,i,b]
    # 1A - 2A block
    ...
    for idet in range(n1a):
        ...
        for jdet in range(n2a):
            ...
            H1A2A[idet,jdet] = (i==k)*(a==c)*H1A['ov'][j,b]\
                              +(i==j)*(a==b)*H1A['ov'][k,c]\
                              -(i==j)*(a==c)*H1A['ov'][k,b]\
                              -(i==k)*(a==b)*H1A['ov'][j,c]\
    ...
    for idet in range(n1a):
        ...
        for jdet in range(n2b):
            ...
            H1A2B[idet,jdet] = (i==j)*H2B['vovv'][a,k,b,c]\
    ...
    for idet in range(n1b):
        ...
        for jdet in range(n2b):
            j,k,b,c = dets2B['inds'][jdet]
            sym2 = dets2B['sym'][jdet]
            H1B2B[idet,jdet] = (i==k)*H2B['ovvv'][j,a,b,c]\
    ...
    for idet in range(n1b):
        ...
        for jdet in range(n2c):
            ...
            H1B2C[idet,jdet] = (i==k)*(a==c)*H1B['ov'][j,b]\
                              +(i==j)*(a==b)*H1B['ov'][k,c]\
                              -(i==j)*(a==c)*H1B['ov'][k,b]\
                              -(i==k)*(a==b)*H1B['ov'][j,c]\
    ...
    for idet in range(n2a):
        ...
        for jdet in range(n1a):
            ...
            sym2 = dets1A['sym'][jdet]
            H2A1A[idet,jdet] = (j==k)*H2A['vvov'][a,b,i,c]\
    ...
    for idet in range(n2b):
        ...
        for jdet in range(n1a):
            k,c = dets1A['inds'][jdet]
            sym2 = dets1A['sym'][jdet]
            H2B1A[idet,jdet] = (i==k)*H2B['vvvo'][a,b,c,j]\
    ...
    for idet in range(n2b):
        ...
        for jdet in range(n1b):
            ...
            sym2 = dets1B['sym'][jdet]
            H2B1B[idet,jdet] = (j==k)*H2B['vvov'][a,b,i,c]\
    ...
    for idet in range(n2c):
        ...
        for jdet in range(n1b):
            k,c = dets1B['inds'][jdet]
            sym2 = dets1B['sym'][jdet]
            H2C1B[idet,jdet] = (j==k)*H2C['vvov'][a,b,i,c]\
    ...
    for idet in range(n2b):
        ...
        for jdet in range(n2b):
            k,l,c,d = dets2B['inds'][jdet]
            sym2 = dets2B['sym'][jdet]
            H2B2B[idet,jdet] = (j==l)*(b==d)*H2A['voov'][a,k,i,c]\
    ...
    for idet in range(n2b):
        ...
        for jdet in range(n2c):
            ...
            sym2 = dets2C['sym'][jdet]
            H2B2C[idet,jdet] = (j==k)*(b==c)*H2B['voov'][a,l,i,d]\
    ...
    for idet in range(n2c):
        ...
        for jdet in range(n2b):
            k,l,c,d = dets2B['inds'][jdet]
            sym2 = dets2B['sym'][jdet]
            H2C2B[idet,jdet] = (i==l)*(a==d)*H2B['ovvo'][k,b,c,j]\

module slater
      ...
      contains
              ...
              subroutine determinant_loop(n1, n2, N_int, dets1, dets2)
                      ...
                      do idet = 1 , n1
                         ...
                         do jdet = 1 , n2
                            ...
                            call get_difference_slater(exc, phase, iflag,&
                                               N_int,&
              ...
              subroutine get_difference_slater(exc, phase, iflag,&
                                               N_int,&
                                               Ha1, Hb1, Pa1, Pb1,&
                                               Ha2, Hb2, Pa2, Pb2)

                      integer, intent(out) :: exc(1:2, 1:2, 1:2, 1:3)
              ...
              end subroutine get_difference_slater

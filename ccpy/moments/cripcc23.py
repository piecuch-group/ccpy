...
from ccpy.utilities.updates import cripcc_loops
...
def calc_cripcc23(T, R, L, omega, corr_energy, H, H0, system, use_RHF=False):
    ...
    dA_aaa, dB_aaa, dC_aaa, dD_aaa = cripcc_loops.cripcc_loops.crcc23a(M3A, L3A, omega,
    ...
    # perform correction in-loop
    dA_aab, dB_aab, dC_aab, dD_aab = cripcc_loops.cripcc_loops.crcc23b(M3B, L3B, omega,
    ...
    # perform correction in-loop
    dA_abb, dB_abb, dC_abb, dD_abb = cripcc_loops.cripcc_loops.crcc23c(M3C, L3C, omega,
                                                                       H0.a.oo, H0.a.vv, H0.b.oo, H0.b.vv,
                                                                       H.a.oo, H.a.vv, H.b.oo, H.b.vv,

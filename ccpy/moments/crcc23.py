...
def crcc23(
    cc_t, H1A, H1B, H2A, H2B, H2C, ints, sys, flag_RHF=False, nroot=0, omega=0.0
):
    ...
    print(
        "CR-CC(2,3)_A = {} Eh     Ecorr_A = {} Eh     Delta_A = {} Eh".format(
            E23A, EcorrA, deltaA
        )
    )
    print(
        "CR-CC(2,3)_B = {} Eh     Ecorr_B = {} Eh     Delta_B = {} Eh".format(
            E23B, EcorrB, deltaB
        )
    )
    print(
        "CR-CC(2,3)_C = {} Eh     Ecorr_C = {} Eh     Delta_C = {} Eh".format(
            E23C, EcorrC, deltaC
        )
    )
    print(
        "CR-CC(2,3)_D = {} Eh     Ecorr_D = {} Eh     Delta_D = {} Eh".format(
            E23D, EcorrD, deltaD
        )
    )

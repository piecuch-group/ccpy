...
def calc_eomcct3(T, R, L, r0, omega, H, H0, system, use_RHF=False, num_active=1):
    """
    ...
    for n in range(nroot):
        ...
        # perform correction in-loop
        dA_aaa, dB_aaa, dC_aaa, dD_aaa = cct3_loops.cct3_loops.creomcc23a_opt(omega[n], r0[n], T.aa, R[n].aa, L[n].a,
                                                                              L[n].aa,
                                                                              H.aa.vooo, I2A_vvov, H.aa.vvov,
                                                                              chi2A_vvvo,
                                                                              chi2A_ovoo, H0.aa.oovv, H.a.ov, H.aa.vovv,
                                                                              H.aa.ooov, H0.a.oo, H0.a.vv, H.a.oo,
                                                                              H.a.vv,
        ...
        # perform correction in-loop
        dA_aab, dB_aab, dC_aab, dD_aab = cct3_loops.cct3_loops.creomcc23b_opt(omega[n], r0[n], T.aa, T.ab, R[n].aa,
                                                                              R[n].ab, L[n].a, L[n].b, L[n].aa, L[n].ab,
        ...
        if use_RHF:
            ...
            dA_abb, dB_abb, dC_abb, dD_abb = cct3_loops.cct3_loops.creomcc23c_opt(omega[n], r0[n], T.ab, T.bb, R[n].ab,
                                                                                  R[n].bb, L[n].a, L[n].b, L[n].ab,
                                                                                  L[n].bb,
                                                                                  I2B_vooo, I2C_vooo, I2B_ovoo,
                                                                                  H.ab.vvov, H.bb.vvov,
                                                                                  ...
                                                                                  H.bb.vooo, H.ab.ovoo,
                                                                                  H.a.ov, H.b.ov, H0.ab.oovv, H.bb.oovv,
                                                                                  H0.a.oo, H0.a.vv,
            ...
            dA_bbb, dB_bbb, dC_bbb, dD_bbb = cct3_loops.cct3_loops.creomcc23d_opt(omega[n], r0[n], T.bb, R[n].bb,
                                                                                  L[n].b, L[n].bb,
    ...
    for n in range(nroot):
        print("   State", n + 1)
        print("   ---------")
        print("   EOMCCSDt = {:>10.10f}    ω = {:>10.10f}".format(system.reference_energy + cc_energy + omega[n],
                                                                 omega[n]))
        print(
            "   CC(t;3)_A = {:>10.10f}     ΔE_A = {:>10.10f}     δ_A = {:>10.10f}".format(

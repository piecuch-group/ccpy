...
def calc_creomcc23(T, R, L, r0, omega, H, H0, system, use_RHF=False):
    ...
    dA_aaa, dB_aaa, dC_aaa, dD_aaa = crcc_loops.crcc_loops.creomcc23a_opt(omega, r0, T.aa, R.aa, L.a, L.aa,
    ...
    # perform correction in-loop
    dA_aab, dB_aab, dC_aab, dD_aab = crcc_loops.crcc_loops.creomcc23b_opt(omega, r0, T.aa, T.ab, R.aa, R.ab, L.a, L.b, L.aa, L.ab,
    ...
    if use_RHF:
        ...
        dA_abb, dB_abb, dC_abb, dD_abb = crcc_loops.crcc_loops.creomcc23c_opt(omega, r0, T.ab, T.bb, R.ab, R.bb, L.a, L.b, L.ab, L.bb,
        ...
        dA_bbb, dB_bbb, dC_bbb, dD_bbb = crcc_loops.crcc_loops.creomcc23d_opt(omega, r0, T.bb, R.bb, L.b, L.bb, 
    ...
    energy_A = cc_energy + omega + correction_A
    energy_B = cc_energy + omega + correction_B
    energy_C = cc_energy + omega + correction_C
    energy_D = cc_energy + omega + correction_D
    ...
    print("   EOMCCSD = {:>10.10f}".format(system.reference_energy + cc_energy))
    print(

...
def test_ipeomccsdt_co():
    ...
    driver.system.set_active_space(nact_occupied=driver.system.noccupied_alpha, nact_unoccupied=driver.system.nunoccupied_alpha)
    r3_excitations = get_active_3h2p_pspace(driver.system, target_irrep=None)
    for i in state_index:
        driver.run_ipeomccp(method="ipeomccsdt_p", state_index=i, r3_excitations=r3_excitations, t3_excitations=t3_excitations)

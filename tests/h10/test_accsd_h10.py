...
def test_ccsd_h10(mf):

    driver = Driver.from_pyscf(mf, nfrozen=0)
    driver.system.print_info()
    driver.run_cc(method="ccsd")

def test_accsd13_h10(mf):
...
def test_accsd134scaled_h10(mf):
...
if __name__ == "__main__":
    ...
    test_accsd13_h10(mf)
    #test_accsd134_h10(mf)
    #test_accsd134scaled_h10(mf)
    #test_accsd14_h10(mf)

...
def get_symmetry_count(sys,nexc):
    ...
    # Count singles
    if nexc == 1:
        countsym, total = count_singles(ncore,noa,nob,norb,ordered_syms,sym_mult_table,ref_sym)
    ...
    # Count doubles
    if nexc == 2:
        countsym, total = count_doubles(ncore,noa,nob,norb,ordered_syms,sym_mult_table,ref_sym)
    ...
    # Count triples
    if nexc == 3:
        countsym, total = count_triples(ncore,noa,nob,norb,ordered_syms,sym_mult_table,ref_sym)

module crcc_loops
      ...
      contains
              ...
              subroutine crcc23A_opt(deltaA,deltaB,deltaC,deltaD,&
                        ...
                        real(kind=8), allocatable :: I2A_vvov_1243(:,:,:,:), H2A_vovv_4312(:,:,:,:), H2A_ooov_4312(:,:,:,:)

                        allocate(I2A_vvov_1243(nua,nua,nua,noa))
                        ! abie -> abei
                        do i1 = 1,nua
                           do i2 = 1,nua
                              do i3 = 1,noa
                                 do i4 = 1,nua
                                    I2A_vvov_1243(i1,i2,i4,i3) = I2A_vvov(i1,i2,i3,i4)
                                 end do
                              end do
                           end do
                        end do
                        allocate(H2A_vovv_4312(nua,nua,nua,noa))
                        ! eiba -> abei
                        do i1 = 1,nua
                           do i2 = 1,noa
                              do i3 = 1,nua
                                 do i4 = 1,nua
                                    H2A_vovv_4312(i4,i3,i1,i2) = H2A_vovv(i1,i2,i3,i4)
                                 end do
                              end do
                           end do
                        end do
                        allocate(H2A_ooov_4312(nua,noa,noa,noa))
                        ! jima -> amji
                        do i1 = 1,noa
                           do i2 = 1,noa
                              do i3 = 1,noa
                                 do i4 = 1,nua
                                    H2A_ooov_4312(i4,i3,i1,i2) = H2A_ooov(i1,i2,i3,i4)
                                 end do
                              end do
                            end do
                        end do
                        ...
                        deallocate(I2A_vvov_1243,H2A_vovv_4312,H2A_ooov_4312)
              ...
              subroutine crcc23B_opt(deltaA,deltaB,deltaC,deltaD,&
                        ...
                        ! debugging
                        integer :: m, n, e, f
                        real(kind=8) :: X3B2(nua,nua,nub), L3B2(nua,nua,nub),&
                        err_m3b, err_l3b
                        ...
                        do i1 = 1,nua
                           do i2 = 1,nua
                              do i3 = 1,noa
                                 do i4 = 1,noa
                                    t2a_1243(i1,i2,i4,i3) = t2a(i1,i2,i3,i4)
                                 end do
                              end do
                           end do
                        end do
                        ...
                        do i1 = 1,nua
                           do i2 = 1,nub
                              do i3 = 1,noa
                                 do i4 = 1,nub
                                    H2B_vvov_1243(i1,i2,i4,i3) = H2B_vvov(i1,i2,i3,i4)
                                 end do
                              end do
                           end do
                        end do
                        ...
                        do i1 = 1,nua
                           do i2 = 1,nub
                              do i3 = 1,noa
                                 do i4 = 1,nob
                                    t2b_1243(i1,i2,i4,i3) = t2b(i1,i2,i3,i4)
                                 end do
                              end do
                           end do
                        end do
                        ...
                        do i1 = 1,nua
                           do i2 = 1,nua
                              do i3 = 1,noa
                                 do i4 = 1,nua
                                    H2A_vvov_1243(i1,i2,i4,i3) = H2A_vvov(i1,i2,i3,i4)
                                 end do
                              end do
                           end do
                        end do
                        ...
                        do i1 = 1,nua
                           do i2 = 1,nob
                              do i3 = 1,nua
                                 do i4 = 1,nub
                                    H2B_vovv_1342(i1,i3,i4,i2) = H2B_vovv(i1,i2,i3,i4)
                                 end do
                              end do
                           end do
                        end do
                        ...
                        do i1 = 1,noa
                           do i2 = 1,nub
                              do i3 = 1,nua
                                 do i4 = 1,nub
                                    H2B_ovvv_2341(i2,i3,i4,i1) = H2B_ovvv(i1,i2,i3,i4)
                                 end do
                              end do
                           end do
                        end do
                        ...
                        do i1 = 1,noa
                           do i2 = 1,nob
                              do i3 = 1,noa
                                 do i4 = 1,nub
                                    H2B_ooov_3412(i3,i4,i1,i2) = H2B_ooov(i1,i2,i3,i4)
                                 end do
                              end do
                           end do
                        end do
                        ...
                        do i1 = 1,noa
                           do i2 = 1,nob
                              do i3 = 1,nua
                                 do i4 = 1,nob
                                    H2B_oovo_3412(i3,i4,i1,i2) = H2B_oovo(i1,i2,i3,i4)
                                 end do
                              end do
                           end do
                        end do
                        ...
                        do i1 = 1,nua
                           do i2 = 1,nub
                              do i3 = 1,noa
                                 do i4 = 1,nob
                                    l2b_1243(i1,i2,i4,i3) = l2b(i1,i2,i3,i4)
                                 end do
                              end do
                           end do
                        end do

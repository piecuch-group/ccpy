                    ...
                    for j in range(i+1,sys['Nocc_a']):
                        for k in range(sys['Nocc_b']):
                            ...
                            if p_spaces['B'][a,b,c,i,j,k] == 1:
                                ...
                                D2 = -H2A['voov'][a,i,i,a]-H2A['voov'][b,i,i,b]+H2B['ovov'][i,c,i,c]\
                                -H2A['voov'][a,j,j,a]-H2A['voov'][b,j,j,b]+H2B['ovov'][j,c,j,c]\
                                +H2B['vovo'][a,k,a,k]+H2B['vovo'][b,k,b,k]-H2C['voov'][c,k,k,c]\
                                -H2A['oooo'][j,i,j,i]-H2B['oooo'][i,k,i,k]-H2B['oooo'][j,k,j,k]\
                                -H2A['vvvv'][b,a,b,a]-H2B['vvvv'][a,c,a,c]-H2B['vvvv'][b,c,b,c]
                                D2 *= -1.0
                        ...
                        for j in range(sys['Nocc_b']):
                            for k in range(j+1,sys['Nocc_b']):
                                ...
                                if p_spaces['C'][a,b,c,i,j,k] == 1:
                                    ...
                                    D2 = -H2A['voov'][a,i,i,a]+H2B['ovov'][i,b,i,b]+H2B['ovov'][i,c,i,c]\
                                    +H2B['vovo'][a,j,a,j]-H2C['voov'][b,j,j,b]-H2C['voov'][c,j,j,c]\
                                    +H2B['vovo'][a,k,a,k]-H2C['voov'][b,k,k,b]-H2C['voov'][c,k,k,c]\
                                    -H2B['oooo'][i,j,i,j]-H2B['oooo'][i,k,i,k]-H2C['oooo'][j,k,j,k]\
                                    -H2B['vvvv'][a,b,a,b]-H2B['vvvv'][a,c,a,c]-H2C['vvvv'][c,b,c,b]
                                    D2 *= -1.0

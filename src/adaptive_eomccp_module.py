...
def eomccsdt_p(nroot,H1A,H1B,H2A,H2B,H2C,cc_t,ints,sys,p_spaces,initial_guess='cis',tol=1.0e-06,maxit=80,flag_RHF=True):
...
def davidson_solver(H1A,H1B,H2A,H2B,H2C,ints,cc_t,nroot,B0,E0,sys,maxit,tol):
    ...
    for iroot in range(nroot):
        ...
        for it in range(maxit):
            ...
            q1a,q1b,q2a,q2b,q2c,q3a,q3b,q3c,q3d = cc_loops.cc_loops.update_r_ccsdt_p(q1a,q1b,q2a,q2b,q2c,q3a,q3b,q3c,q3d,\
                            omega[iroot],p_spaces['A'],p_spaces['B'],p_spaces['C'],p_spaces['D'],\

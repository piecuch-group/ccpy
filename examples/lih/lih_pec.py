...
if __name__ == "__main__":
    ...
    np.save("ccsdt_ccpcvdz.npy", energy)
    np.save("ccsdt_ccpcvdz_convg.npy", convg_ground)
    np.save("eomccsdt_ccpcvdz.npy", omega)
    np.save("eomccsdt_ccpcvdz_convg.npy", convg_excited)
